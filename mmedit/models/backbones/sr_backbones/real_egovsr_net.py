...
from mmedit.models.backbones.sr_backbones.egovsr_net import (
    EGOVSRNet, ResidualBlocksWithInputConv)
from mmedit.models.registry import BACKBONES
from mmedit.utils import get_root_logger


@BACKBONES.register_module()
class RealEGOVSRNet(nn.Module):
    """RealEGOVSR network structure for real-world egocentric video super-resolution.
    ...
    def __init__(self,
        ...
        # BasicVSR
        self.basicvsr = EGOVSRNet(mid_channels, num_propagation_blocks,
                                    spynet_pretrained)
        self.basicvsr.spynet.requires_grad_(False)

    def forward(self, lqs, return_lqs=False, gt_clean=None):
        n, t, c, h, w = lqs.size()
        ...
        outputs = self.basicvsr(lqs ,gt_clean)
